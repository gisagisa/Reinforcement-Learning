...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('Tugas Modifikasi RL Q-learning. Sichkar Valentyn')
    ...
    def build_environment(self):
        ...
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 4, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 7, 0, anchor='nw', image=self.obstacle12_object)
        # Obstacle 6
        ...
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 2, pixels * 2, anchor='nw', image=self.obstacle10_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 7, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 6, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 8, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 6, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(0, pixels * 8, anchor='nw', image=self.obstacle3_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 5, pixels * 5, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        ...
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 8, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        ...
        self.flag = self.canvas_widget.create_image(pixels * 8, pixels * 8, anchor='nw', image=self.flag_object)
